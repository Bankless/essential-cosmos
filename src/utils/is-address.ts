...
export const isGravityBridgeAddress = buildChainAddressValidator("gravityBridge");
...
export const isKonstellationAddress = buildChainAddressValidator("konstellation");
